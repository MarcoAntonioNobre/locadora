<div class="card mt-2">
    <div class="d-flex justify-content-between card-header cinza">
        <h5 class="fs-2 text-black"><i class="bi bi-person-fill text-black"></i> Administradores</h5>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header cinza">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">
                                                Administrador <?php echo $nome ?></h1>
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                <div>
                                                    <b>Nome do Administrador:</b> <?php echo $nome ?>
                                                </div>
                                                <hr>
                                                <div>
                                                    <b>Email de <?php echo
                                                        $nome; ?></b> <?php echo $email ?>
                                                </div>
                                                <hr>
                                                <div>
